...
const styles = StyleSheet.create({
  ...
  personas: { fontWeight: 'bold', color: '#2196F3' },
  tel: { fontSize: 12, color: '#555', marginBottom: 2 },
  espera: { fontSize: 12, color: '#888', marginBottom: 8 },
  ...
  estadoBadge: { backgroundColor: '#eee', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 10 },
  estadoAvisado: { backgroundColor: '#FFF3E0' },
  estadoText: { fontSize: 11, color: '#555' },
